                        ...
                        <div class="row">
                            <div class="col-md-4">
                              ...
                              <div class="form-group col-md-4 ">
                                    <label class="form-control-label font-weight-bold"> @lang('Admin Email') </label>
                                    <input class="form-control form-control-lg" type="email" name="admin_email" value="{{$general->admin_email}}">
                                </div>
                            ...
                            <div class="form-group col-md-4">
                             ...
                             <div class="form-group col-md-8 ">
                                    <label class="form-control-label font-weight-bold"> @lang('Radio Url') </label>
                                    <input class="form-control form-control-lg" type="text" name="radio_url" value="{{$general->radio_url}}">
                                </div>
