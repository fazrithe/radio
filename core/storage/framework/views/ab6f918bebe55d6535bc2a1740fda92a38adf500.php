        ...
        <nav class="navbar navbar-expand-xl p-0 align-items-center">
          ...
          <div class="collapse navbar-collapse mt-lg-0 mt-3" id="navbarSupportedContent">
            <ul class="navbar-nav main-menu ms-auto align-items-center">
              ...
              <li><a href="<?php echo e(route('jockey')); ?>"><?php echo app('translator')->get('Blog'); ?></a></li>
  ...
  <!-- header-section end  -->
<?php /**PATH C:\laragon\www\harmony\core\resources\views/templates/basic/partials/navbar.blade.php ENDPATH**/ ?>