<?php $__env->startSection('panel'); ?>
    ...
    <div class="row">
        ...
        <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-header bg--primary"><h4 class="card-title text-white"> <?php echo e(__(inputTitle($temp['name']))); ?> </h4></div>
                    <div class="card-body">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp7.4\htdocs\radioallomas\core\resources\views/admin/frontend/templates.blade.php ENDPATH**/ ?>